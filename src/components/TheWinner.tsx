import { clearState, winner } from '@/store';
import { useStore } from '@nanostores/react';

export default function Winner() {
    const theWinner = useStore(winner);
    if (!theWinner) return null;
    return (
        <div className="flex flex-col justify-center items-center flex-full">
            <p className="mt-8 text-4xl font-bold text-center mb-2">
                <span className="capitalize text-primary">{theWinner}</span> wins!
            </p>
            ...
            <button onClick={clearState} className="btn text-white btn-sm mt-4">
                <svg
